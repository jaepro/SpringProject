...
<form id="uploadUpdateForm">
	...
	<table border="1">
		<tr>
			<th>상품명</th>
			<td>
				<input type="text" name="imageName" value="${userUploadDTO.imageName }" size="35">
			</td>
		</tr>	
			...
			<td colspan="2">
				...
				<span id="showImageList">
					<img alt="${userUploadDTO.imageName }" 
						src="https://kr.object.ncloudstorage.com/bitcamp-9th-bucket-124/storage/${userUploadDTO.imageFileName }" width="70" height="70">
				</span>
